...
const AdminDashboard = () => {
  ...
  return (
    <div className="container mx-auto min-h-screen px-4 py-6 space-y-8 bg-gradient-soft text-foreground">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="sticky top-0 z-10 grid w-full grid-cols-7 gap-1 rounded-xl border bg-background/80 p-1 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 rounded-t-lg bg-gradient-to-r from-pink-50/70 to-transparent dark:from-pink-950/30">
